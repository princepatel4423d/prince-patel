...
const AddWork = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${backendUrl}/api/work/create`, {
        method: "POST",
    ...
    <div className="w-full p-6 bg-white dark:bg-neutral-900 rounded-2xl shadow-lg text-neutral-900 dark:text-neutral-100">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 items-center">
          ...
          {/* End Date with dropdown like AddEducation */}
